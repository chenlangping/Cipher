...
public class Vigenere extends JDialog implements ActionListener {
            ...
            public void actionPerformed(ActionEvent Event) {
                ...
                if (encryption.isSelected() == true) {
                    if (plaintext.equals("") && key.equals("")) {
                        ...
                        // 执行加密算法
                        ciphertextinput.setText(new Encrypt().Vigenere(plaintext, key));
                    ...
                    if (ciphertext.equals("") && key.equals("")) {
                        ...
                        plaintextinput.setText(new Decrypt().Vigenere(ciphertext, key));
                }
            }
        });
                ...
                if (fileencryption.isSelected() == true) {
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileplaintextlegal && filekeylegal) {
                            // 执行加密算法
                            fileciphertext = new Encrypt().Vigenere(fileplaintext, filekey);
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileciphertextlegal && filekeylegal) {
                            fileplaintext = new Decrypt().Vigenere(fileciphertext, filekey);
