...
public class Keyword extends JDialog implements ActionListener {
            ...
            public void actionPerformed(ActionEvent Event) {
                ...
                if (encryption.isSelected() == true) {
                    if (plaintext.equals("") && key.equals("")) {
                        ...
                        // 执行加密算法
                        ciphertextinput.setText(new Encrypt().Keyword(plaintext, key));
                    ...
                    if (ciphertext.equals("") && key.equals("")) {
                        ...
                        // 执行解密算法
                        plaintextinput.setText(new Decrypt().Keyword(ciphertext, key));
                }
            }
        });
                ...
                if (fileencryption.isSelected() == true) {
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileplaintextlegal && filekeylegal) {
                            // 执行加密算法
                            fileciphertext = new Encrypt().Keyword(fileplaintext, filekey);
                            ...
                            JOptionPane.showMessageDialog(jf, "在明文和密钥中都检测到非法字符！");
                    }
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileciphertextlegal && filekeylegal) {
                            fileplaintext = new Decrypt().Keyword(fileciphertext, filekey);
                            ...
                            JOptionPane.showMessageDialog(jf, "在密文和密钥中都检测到非法字符！");
                    }
                    // 执行解密算法
