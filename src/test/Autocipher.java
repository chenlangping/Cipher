...
public class Autocipher extends JDialog implements ActionListener {
            ...
            public void actionPerformed(ActionEvent Event) {
                ...
                if (encryption.isSelected()) {
                    if (plaintext.equals("") && key.equals("")) {
                        ...
                        // 执行加密算法
                        ciphertextinput.setText(new Encrypt().Autocipher(plaintext, key));
                    ...
                    if (ciphertext.equals("") && key.equals("")) {
                        ...
                        // 执行解密算法
                        plaintextinput.setText(new Decrypt().Autocipher(ciphertext, key));
                }
                ...
                if (fileencryption.isSelected() == true) {
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileplaintextlegal && filekeylegal) {
                            // 执行加密算法
                            fileciphertext = new Encrypt().Autocipher(fileplaintext, filekey);
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileciphertextlegal && filekeylegal) {
                            fileplaintext = new Decrypt().Autocipher(fileciphertext, filekey);
