...
public class ColumnPermutationcipher extends JDialog implements ActionListener {
    ...
    public ColumnPermutationcipher() {
        jf = new JFrame("列置换密码");
            ...
            public void actionPerformed(ActionEvent Event) {
                ...
                if (encryption.isSelected() == true) {
                    if (plaintext.equals("") && key.equals("")) {
                        ...
                        // 执行加密算法
                        ciphertextinput.setText(new Encrypt().ColumnPermutationcipher(plaintext, key));
                    ...
                    if (ciphertext.equals("") && key.equals("")) {
                        ...
                        // 执行解密算法
                        plaintextinput.setText(new Decrypt().ColumnPermutationcipher(ciphertext, key));
                }
            }
        });
                ...
                if (fileencryption.isSelected() == true) {
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileplaintextlegal && filekeylegal) {
                            // 执行加密算法
                            fileciphertext = new Encrypt().ColumnPermutationcipher(fileplaintext, filekey);
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileciphertextlegal && filekeylegal) {
                            fileplaintext = new Decrypt().ColumnPermutationcipher(fileciphertext, filekey);
