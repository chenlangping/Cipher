...
public class Permutation extends JDialog implements ActionListener {
            ...
            public void actionPerformed(ActionEvent Event) {
                ...
                if (encryption.isSelected() == true) {
                    if (plaintext.equals("") && key.equals("")) {
                        ...
                        // 执行加密算法
                        ciphertextinput.setText(new Encrypt().Permutationcipher(plaintext, key));
                    ...
                    if (ciphertext.equals("") && key.equals("")) {
                        ...
                        // 执行解密算法
                        plaintextinput.setText(new Decrypt().Permutationcipher(ciphertext, key));
                }
            }
        });
                ...
                if (fileencryption.isSelected() == true) {
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileplaintextlegal && filekeylegal) {
                            // 执行加密算法
                            fileciphertext = new Encrypt().Permutationcipher(fileplaintext, filekey);
                    ...
                    if (fileplaintextinput.getText().equals("") && fileciphertextinput.getText().equals("")
                        ...
                        if (fileciphertextlegal && filekeylegal) {
                            fileplaintext = new Decrypt().Permutationcipher(fileciphertext, filekey);
